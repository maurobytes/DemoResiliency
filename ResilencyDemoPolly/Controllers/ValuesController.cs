...
namespace ResilencyDemoPolly.Controllers
{
    public class ValuesController : ApiController
    {
        ...
        /// message.</param>
        /// <returns>Returns: "Respuesta desde el servidor a la solicitud #{id}"</returns>

        public Models.Message Get(int id)
        {
            var msg = new Models.Message
            {
                Text = "Respuesta desde el servidor a la solicitud #" + id.ToString()
            };
            return msg;
        }
